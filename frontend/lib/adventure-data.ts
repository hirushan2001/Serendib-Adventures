...
export const adventures: Tour[] = [
  {
    ...
    overview: "Conquer five major rapids and four minor rapids on the historic Kelani River. Guided by certified swift-water rescue instructors, this classic Kitulgala trip combines thrilling whitewaters with pristine rainforest views.",
    highlights: [
      "Navigate 5 major Grade 3/4 rapids (Head Chopper, Virgin's Breast, Butter Fly)",
      "Safety gear included: Helmets, life jackets, and safety kayakers",
      "Body surfing and flat-water river swim at the finish",
      "Traditional Sri Lankan buffet lunch by the riverbank"
    ],
    included: ["Professional raft guide & safety crew", "All technical safety equipment", "Buffet lunch & fresh king coconut", "Changing room access & locker storage"],
